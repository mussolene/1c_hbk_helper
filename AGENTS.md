...
- **save_1c_snippet:** сохранённый код пишется в файлы сниппетов и в memory — при конфиденциальном коде настройте SNIPPETS_DIR и MEMORY_BASE_PATH в защищённое место.
